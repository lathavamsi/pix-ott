package com.revature.fsd.pixott.customer.dao;
	...
	public class LoginDao {
		...
		public static boolean resultcheck(String num, String pass) {
			String sql = String.format("select * from customername where number= '%s' && password= '%s';",num,pass);
		...
		public static  String nameuser(String num) {
			String sml = String.format("select name from customername where number ='%s';",num);
			String nameofuser="";
			try (
					Connection connection = Util.getConnection();
